    ...
    groups: [
      {
        ...
        steps: [
          `היכנסו לאתר הרשמי של רשות מקרקעי ישראל: https://www.gov.il/he/service/rights-approval-request`,
...
function DocumentGuideStation() {
  return (
    <section id="document-guides" className="bg-background py-20 md:py-28">
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "בדיקת מיחזור משכנתא | אורן סממה - ייעוץ משכנתאות" },
      {
        name: "description",
        content:
          "בדיקת כדאיות מיחזור משכנתא ללא עלות — מדריך שלב אחר שלב להפקת דוח יתרות לסילוק, והעלאת הדוח לבדיקה מקצועית אצל אורן סממה, יועץ משכנתאות אסטרטגי.",
      },
      { property: "og:title", content: "אורן סממה - ייעוץ משכנתאות" },
      {
        property: "og:description",
        content: "בדיקת כדאיות מיחזור משכנתא ללא עלות, ליווי אישי לאורך כל תהליך המשכנתא.",
      },
    ],
  }),
  component: Index,
